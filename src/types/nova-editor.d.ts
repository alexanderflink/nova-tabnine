...
interface AssistantsRegistry {
  ...
  registerTaskAssistant(
    ...
    options?: { identifer: string; name: string },
  ): Disposable
}
...
declare class Process {
  ...
  onStdout(callback: (line: string) => void, thisValue?: any): Disposable
  onStderr(callback: (line: string) => void, thisValue?: any): Disposable
  onDidExit(callback: (status: number) => void, thisValue?: any): Disposable
  start(): void
